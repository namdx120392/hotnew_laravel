...
jQuery.fn.slugIt = function(options) {
    ...
    function latin_map() {
        return {
            ...
            'û': 'u', 'ü': 'u', 'ű': 'u', 'ý': 'y', 'þ': 'th', 'ÿ': 'y', 'ư':'u', 'ă':'a',
            'ầ':'a','ấ':'a','ắ':'a', 'ằ':'a','ứ':'u', 'ừ':'u','ữ':'u','ự':'u','ả':'a','ạ':'a',
            'ồ':'o', 'ố':'o', 'ộ':'o', 'ổ':'o', 'ị':'i','ỉ':'i','ẩ':'a','ậ':'a','đ':'d',
            'ệ':'e','ỏ':'o','ọ':'o','ờ':'o','ũ':'u','ớ':'o','ề':'e','ơ':'o','ĩ':'i','ể':'e',
            'ẫ':'a','ế':'e','ặ':'a','ẽ':'e','ẹ':'e','ủ':'u','ễ':'e','ợ':'o','ử':'u'
        };
    }
